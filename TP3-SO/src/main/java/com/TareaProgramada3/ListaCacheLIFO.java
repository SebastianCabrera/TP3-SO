...
public class ListaCacheLIFO extends ListaCache{
    ...
    public ListaCacheLIFO(String idParam, int tamanoParam, int tiempoVidaCacheParam)
    {
        id = idParam;
        tamano = tamanoParam;
    ...
    public ListaCacheLIFO(int tamanoParam, String idParam, int tiempoVidaElemParam)
    {
        id = idParam;
        tamano = tamanoParam;
    ...
    public ListaCacheLIFO(int tamanoParam, String idParam)
    {
        id = idParam;
        tamano = tamanoParam;
        tiempoVidaCache = tiempoVidaCache_DEFAULT;
    ...
    public ListaCacheLIFO(int tamanoParam, int tiempoVidaCacheParam,int tiempoVidaElemParam,String idParam)
    {
        id = idParam;
        tamano = tamanoParam;
        tiempoVidaCache = tiempoVidaCacheParam;
    ...
    /// Esta función regresa la key asignada al objeto más nuevo en la lista
